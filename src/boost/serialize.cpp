...
//   int get_degrees() { return degrees; }
//   int get_minutes() { return minutes; }
//   float get_seconds() { return seconds; }
// };
// constexpr std::string file = "bserl_filename";
// int main() {
...
//   const gps_position g2(2636, 1159, 5924.567f);
...
//     // archive and stream closed when destructors are called
//   }
//   std::cout << newg.get_degrees() << " " << newg.get_minutes() << " "
//             << newg.get_seconds() << std::endl;
//   std::cout << newg2.get_degrees() << " " << newg2.get_minutes() << " "
//             << newg2.get_seconds() << std::endl;
//   return 0;
// }
