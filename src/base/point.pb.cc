...
PROTOBUF_CONSTEXPR Geo::Geo(
  ...
  , /*decltype(_impl_._lines_cached_byte_size_)*/{0}
...
const uint32_t TableStruct_point_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::dispatch::Geo, _impl_.lines_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_point_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013point.proto\022\010dispatch\"B\n\003Geo\022\014\n\004name\030\001"
  " \001(\t\022\036\n\005point\030\002 \001(\0132\017.dispatch.Point\022\r\n\005"
  "lines\030\003 \003(\r\"\035\n\005Point\022\t\n\001x\030\001 \001(\001\022\t\n\001y\030\002 \001"
  "(\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_point_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_point_2eproto = {
    false, false, 130, descriptor_table_protodef_point_2eproto,
    "point.proto",
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt32Parser(_internal_mutable_lines(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 24) {
          _internal_add_lines(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Geo::_InternalSerialize(
  ...
  // repeated uint32 lines = 3;
  {
    int byte_size = _impl_._lines_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(
          3, _internal_lines(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:dispatch.Geo)
  ...
  // repeated uint32 lines = 3;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt32Size(this->_impl_.lines_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._lines_cached_byte_size_.store(cached_size,
